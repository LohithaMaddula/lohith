    ...
    def fill_attendance():
        ...
        if subb=='':
            ...
            def create_csv():
                ...
                connection.commit()
                csv_name='C:/Users/lohit/OneDrive/Documents/GitHub/LohithaMaddula.github.io/Attendace_management_system-master/Attendance'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(r'explorer /select,"C:/Users/lohit/OneDrive/Documents/GitHub/LohithaMaddula.github.io/Attendace_management_system-master/Attendance/Manually Attendance/-------Check atttendance-------"')
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='snow')
                cs = 'C:/Users/lohit/OneDrive/Documents/GitHub/LohithaMaddula.github.io/Attendace_management_system-master/' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(r'explorer /select,"C:/Users/lohit/OneDrive/Documents/GitHub/LohithaMaddula.github.io/Attendace_management_system-master/Attendance/-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'Lohitha003' :
            if password == 'demo123':
                ...
                cs = 'C:/Users/lohit/OneDrive/Documents/GitHub/LohithaMaddula.github.io/Attendace_management_system-master/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
